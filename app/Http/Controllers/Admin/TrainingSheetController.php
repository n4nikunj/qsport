...
class TrainingSheetController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:training_sheet-list', ['only' => ['index','show']]);
        $this->middleware('permission:training_sheet-create', ['only' => ['create','store']]);
        $this->middleware('permission:training_sheet-edit', ['only' => ['edit','update']]);
    }
