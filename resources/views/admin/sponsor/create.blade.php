    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          ...
          <form method="POST" id="sponsors" action="{{route('sponsors.store')}}" accept-charset="UTF-8" enctype="multipart/form-data">
            @csrf
            <div class="box-body">
               ...
               <div class="form-group">
                      ...
                      <input class="form-control"  placeholder="{{trans('sponsors.name')}}" name="name" type="text" value="{{old('name')}}">
                      <strong class="help-block"></strong>
                    </div>
                
              <div class="form-group">
                      <label for="website" class="content-label">{{trans('sponsors.website')}}</label>
                      <input class="form-control"  placeholder="{{trans('sponsors.website')}}" name="website" type="text" value="{{old('website')}}">
                      <strong class="help-block"></strong>
                    </div>
				 <div class="form-group">
			 ...
			 <div class="form-group">
			   ...
			   <input type="text" class="form-control" name="email" placeholder="{{trans('sponsors.email')}}" value="{{old('email')}}">
			</div>	
			<div class="form-group">
			   <label for="sponsors_category" class="content-label">{{trans('sponsors.sponsor_category')}}</label>
				...
				<option value="{{trans('sponsors.standard')}}">{{trans('sponsors.standard')}}</option>
				<option value="{{trans('sponsors.premium')}}">{{trans('sponsors.premium')}}</option>
				</select>
