<?php $__env->startSection('content'); ?>
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active"><?php echo e(trans('products.add_new')); ?></li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          ...
          <form method="POST" id="products" action="<?php echo e(route('products.store')); ?>" accept-charset="UTF-8" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="<?php echo e(trans('products.name')); ?>" value="<?php echo e(old('name')); ?>">
                  </div>
                  <div class="form-group">
                    <label for="name" class="content-label"><?php echo e(trans('products.description')); ?></label>
                    <textarea class="form-control" rows="9" name="description"><?php echo e(old('description')); ?></textarea>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="rate" placeholder="<?php echo e(trans('products.rate')); ?>" value="<?php echo e(old('rate')); ?>">
                  </div>
                  <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\qsport\resources\views/admin/products/create.blade.php ENDPATH**/ ?>