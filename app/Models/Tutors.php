...
class Tutors extends Model implements HasMedia
{
    ...
    protected $fillable = ['user_id','country_code','phoneno', 'email','country_id','address','currency','rate','lat','long','facebook','youtube','twitter','insta','snapchat','profile_status','status'];
	/**
     * @var string
     */
    /**
